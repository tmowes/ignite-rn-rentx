...
export const Profile = () => {
  ...
  const animatedText1 = useAnimatedStyle(() => ({
    color: interpolateColor(currIndex.value, [0, 1], [colors.title, colors.textDetails]),
  }))
  const animatedText2 = useAnimatedStyle(() => ({
    color: interpolateColor(currIndex.value, [1, 0], [colors.title, colors.textDetails]),
  }))
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <S.Container>
          ...
          <S.Footer>
            <C.LabelButton label="Salvar alterações" onPress={handleUpdateUser} />
          </S.Footer>
        </S.Container>
      </TouchableWithoutFeedback>
    </KeyboardAvoidingView>
